...
imapserver = "imap.gmail.com"  # servidor imap "imap.gmail.com"  "imap.zoho.com"
smtpserver = "smtp.gmail.com"  # servidor smtp "smtp.gmail.com"  "smtp.zoho.com"
smtpserverport = 587  # puerto tls smtp        587 gmail         465 zohomail 
imapserverport = 25  # puerto tls imap        25  gmail         993 zohomail
